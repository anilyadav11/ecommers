...
<head>
    ...
    <title>Swarnagowri Foods and Beverages Private Limited</title>
                ...
                <div class="header-top-inner">
                    <div class="cnt-account">
                        <ul class="list-unstyled">
                            <li><a href="#"><i class="fa fa-phone"></i> &nbsp; +91 6360264649</a></li>
                            <li><a href="#"><i class="fa fa-envelope-o"></i> &nbsp; swarnagowrifoodsbeverages@gmail.com</a></li>
                        </ul>
                    </div>
                    <div class="offer-text">Welcome to Swarnagowri Foods and Beverages</div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                        <div class="logo">
                            <a href="index.html">
                                <img src="assets/images/logo.png" alt="Swarnagowri Foods and Beverages Private" style="margin-top:-5px;">
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="nav-outer">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown  navbar-right special-menu">
                                        <a href="userpages/openentry.aspx">Sign up Now </a>
                                    </li>
                                </ul>
                                <div class="clearfix"></div>
                            </div>
            ...
            <div class="sign-in-page ">
                <div class="row ">
                    <div class="col-md-8 col-sm-8 sign-in">
                        ...
                        <form class="register-form outer-top-xs" role="form" method="post" action="{{route('user.insert')}}">
                            @csrf
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">User Name</label>
                                <input type="text" name="name" class="form-control unicase-form-control text-input" id="memberid">
                            </div>
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">User Email</label>
                                <input type="email" name="email" class="form-control unicase-form-control text-input" id="memberid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control unicase-form-control text-input" id="pwd">
                                @error('password')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">User Mobile Number</label>
                                <input type="text" name="phone" class="form-control unicase-form-control text-input" id="memberid">
                                @error('phone')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">User Address</label>
                                <input type="text" name="address" class="form-control unicase-form-control text-input" id="memberid">
                                @error('address')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">User Country</label>
                                <input type="text" name="country" class="form-control unicase-form-control text-input" id="memberid">
                                @error('country')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">User State</label>
                                <input type="text" name="state" class="form-control unicase-form-control text-input" id="memberid">
                                @error('state')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">User City</label>
                                <input type="text" name="city" class="form-control unicase-form-control text-input" id="memberid">
                                @error('city')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label class="info-title" for="exampleInputEmail1">User Zip</label>
                                <input type="text" name="postal_code" class="form-control unicase-form-control text-input" id="memberid">
                                @error('postal_code')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="module-body">
                            <ul class="toggle-footer">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body"> <span><a href="#">swarnagowrifoodsbeverages@gmail.com</a></span> </div>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        ...
                        <div class="module-body">
                            <ul class='list-unstyled'>
                                <iframe src="https://shnc.in/shownews.aspx" style="width:100%; height:240px; border-radius:6px;  border:none;"></iframe>
                            </ul>
                        </div>
                    </div>
